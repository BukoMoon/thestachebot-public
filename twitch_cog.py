...
Modified from original: https://github.com/Gunsmithy/TwitchLiveNotifier

:modified: 2021 Louis Adams
:copyright: (c) 2017 Dylan Kauling
...
__license__ = 'GPLv3'
__copyright__ = 'Copyright 2017 Dylan Kauling'
__version__ = '0.3-modified'
...
def main():
    ...
    while len(twitch_json['data']) == 0:
        ...
        while request_status == 401:
            ...
            # if twitch API doesn't return anything    
            try:
                twitch_json = twitch_request.json()
            except json.decoder.JSONdDecodeError:
                return 2
